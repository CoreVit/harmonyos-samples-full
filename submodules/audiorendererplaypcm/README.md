...
| 直板机                                                | 折叠屏                                               | 平板                                                   | 
|----------------------------------------------------|---------------------------------------------------|------------------------------------------------------|
| <img src="screenshots/device/index.png" width=320> | <img src="screenshots/device/fold.png" width=640> | <img src="screenshots/device/tablet.png" width=1120> |
...
│  │  └──utils                                            // 工具函数
│  │     ├──mediautils                                    // 媒体方法
│  │     │  ├──AudioRendererController.ets                // AudioRender播放类
...
1. 播放功能：本文使用AudioRenderer接口实现音频播放功能。从rawfile目录下获取pcm文件后，通过AudioRenderer接口实现播放功能。
2. 倍速、音量、静音模式功能调用的是AudioRenderer自身的接口，详细接口使用可见具体代码。
