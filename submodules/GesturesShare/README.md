...
| 手机                                            | 折叠屏                                          | 平板                                          |
|-----------------------------------------------|----------------------------------------------|---------------------------------------------|
| <img src="screenshots/device/phone_file.png"> | <img src="screenshots/device/fold_file.png"> | <img src="screenshots/device/pad_file.png"> |
| <img src="screenshots/device/phone_url.png">  | <img src="screenshots/device/fold_url.png">  | <img src="screenshots/device/pad_url.png">  |
...
2. 在完成App Linking的配置后，请前往[ShareModel.ets](feature/gesturesshareshare/src/main/ets/model/ShareModel.ets)文件，将share()方法中的content参数替换为真实可用的链接地址，同时将[module.json5](gesturessharesample/src/main/module.json5)文件中uris的host修改为可用的域名。
...
2. HarmonyOS系统：HarmonyOS 6.0.2及以上。
3. DevEco Studio版本：DevEco Studio 6.0.2及以上。
4. HarmonyOS SDK版本：HarmonyOS 6.0.2 SDK及以上。