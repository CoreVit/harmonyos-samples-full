...
|                          **手机**                          |                       **折叠屏**                        |                          **平板**                          |
| :--------------------------------------------------------: | :-----------------------------------------------------: | :--------------------------------------------------------: |
| <img src="screenshots/device/phone_en.png" alt="Index"  /> | <img src="screenshots/device/fold_en.png" alt="Get"  /> | <img src="screenshots/device/tablet_en.png" alt="Copy"  /> |
...
│     ├──VideoSnapshotDialog.ets        // Video screenshot component
...
1. This sample is only supported on Bar phone, Bi-fold phone, Tri-fold phone, Widescreen foldable phone, Tablet and PC/2in1 running standard systems.
