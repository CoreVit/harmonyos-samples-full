...
|                          **手机**                          |                       **折叠屏**                        |                          **平板**                          |
| :--------------------------------------------------------: | :-----------------------------------------------------: | :--------------------------------------------------------: |
| <img src="screenshots/device/phone_cn.png" alt="Index"  /> | <img src="screenshots/device/fold_cn.png" alt="Get"  /> | <img src="screenshots/device/tablet_cn.png" alt="Copy"  /> |
...
│     ├──VideoSnapshotViewDialog.ets    // 视频截图组件
...
1. 本示例仅支持标准系统上运行，支持设备：直板机、双折叠、三折叠、阔折叠、平板、PC/2in1。
