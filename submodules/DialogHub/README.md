...
|                            自定义弹窗                             |                            跟手弹窗                             |
|:------------------------------------------------------------:|:-----------------------------------------------------------:|
|  <img src="./screenshots/device/zh/custom.png" width="320">  |  <img src="./screenshots/device/zh/popup.png" width="320">  |

|                            半模态弹窗                            |                           Toast弹窗                           |
|:-----------------------------------------------------------:|:-----------------------------------------------------------:|
|  <img src="./screenshots/device/zh/sheet.png" width="320">  |  <img src="./screenshots/device/zh/toast.png" width="320">  |
...
## 具体实现
[查看详情](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-hadss_dialoghub#section43371133181816)
 	 
## 相关权限
不涉及

## 约束与限制
- 本示例仅支持标准系统上运行，支持设备：直板机、双折叠、三折叠、阔折叠、平板、PC/2in1。
