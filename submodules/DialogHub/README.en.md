...
|                      Custom Dialog Box                      |                 Finger-following Dialog Box                 |
|:-----------------------------------------------------------:|:-----------------------------------------------------------:|
| <img src="./screenshots/device/en/custom.png" width="320">  |  <img src="./screenshots/device/en/popup.png" width="320">  |

|                   Semi-modal Dialog Box                    |                      Toast Dialog Box                       |
|:----------------------------------------------------------:|:-----------------------------------------------------------:|
| <img src="./screenshots/device/en/sheet.png" width="320">  |  <img src="./screenshots/device/en/toast.png" width="320">  |
...
## Constraints
- This sample is only supported on Huawei standard systems. Supported devices include: Phone, Tablet, and PC/2in1.
- The HarmonyOS version must be HarmonyOS 5.0.3 Release or later.
- The DevEco Studio version must be DecEco Studio 6.0.0 Release or later.
