...
│  │  ├──Logger.ets                 // Logger utils
│  │  └──OpacityUtil.ets            // Opacity utils
│  ├──view
│  │  ├──AdjustContentView.ets      // Adjust component
│  │  ├──ApplyFilterView.ets        // Filter component
│  │  ├──CropView.ets               // Crop component
│  │  ├──TranslateView.ets          // Translate component
│  │  └──ZoomView.ets               // Zoom component
│  ├──viewModel           
│  │  ├──IconListViewModel.ets      // Icon Model
│  │  ├──MessageItem.ets            // Message
│  │  ├──OptionViewModel.ts         // Option model
│  │  └──RegionItem.ets             
│  └──workers
