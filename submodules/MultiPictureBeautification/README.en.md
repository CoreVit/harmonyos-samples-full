...
|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------------:|
| <img src="screenshots/device/purax_en.png"> | <img src="screenshots/device/phone_en.png"> | <img src="screenshots/device/double_fold_en.png"> |

|                  **tablet**                  |                  **pc**                  |
|:--------------------------------------------:|:----------------------------------------:|
| <img src="screenshots/device/tablet_en.png"> | <img src="screenshots/device/pc_en.png"> |
