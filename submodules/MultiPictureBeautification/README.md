...
|                 **purax外屏**                 |                   **直板机**                   |                      **双折叠**                      |
|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------------:|
| <img src="screenshots/device/purax_cn.png"> | <img src="screenshots/device/phone_cn.png"> | <img src="screenshots/device/double_fold_cn.png"> |

|                    **平板**                    |                  **电脑**                  |
|:--------------------------------------------:|:----------------------------------------:|
| <img src="screenshots/device/tablet_cn.png"> | <img src="screenshots/device/pc_cn.png"> |
