...
基于自适应和响应式布局，实现一次开发、多端部署的社区应用。

## 效果预览

| 阔折叠外屏                                              | 直板机                                                | 折叠屏                                                   |
|----------------------------------------------------|----------------------------------------------------|-------------------------------------------------------|
| <img src='screenshots/device/purax.png' width=320> | <img src='screenshots/device/phone.png' width=320> | <img src='screenshots/device/fold.png' width=480> |

| 平板                                                  | 电脑                                                |
|-----------------------------------------------------|---------------------------------------------------|
| <img src='screenshots/device/pad.png' width=800> | <img src='screenshots/device/2in1.png' width=800> |
## 使用说明
